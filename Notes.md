...
## Tasks:
During the meeting:
- Ask if we should spend time writing matlab functions in python
- Show images from preprocessing steps --> Emma
- LDA accuracy plot --> Felipe
- EEGNet accuracy plot --> Felipe
- Markov plot --> Radu
- Statistical plots --> Emma

Emma:
- Write about preprocessing methods
- Generate preprocessing images
- Replicated Matlab code and save intermediary results
- Come up and try out different filtering methods to talk about during the meeting
