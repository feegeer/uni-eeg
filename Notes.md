...
1. Temporal Generalization (Cross-Temporal Decoding):
...
1. Computational Strategy Modeling (RL Analysis):
...
1. Inter-Brain Representational Similarity Analysis (RSA):
...
1. Source Localization of Decoding Topographies:
...
1. Microstate Analysis during the "Decision" Phase:
